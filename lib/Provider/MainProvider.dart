...
class MainProvider extends ChangeNotifier{
  ...
  Future<void>getCurrentOrders()async{
    ...
    try
    {
      ...
      if(response.statusCode==200 && response.body!=null)
      {
        ...
        List slideritems = json.decode(utf8.decode(response.bodyBytes))["data"]["data"]["current"];
  ...
  Future<void>getPastOrders()async{
    ...
    try
    {
      ...
      if(response.statusCode==200 && response.body!=null)
      {
        ...
        List slideritems = json.decode(utf8.decode(response.bodyBytes))["data"]["data"]["previous"];
        print(slideritems.length);
        print("++++++++++++++++++++++++++++++++++++++++++++");
  ...
  Future<void>getOffers()async{
    var url=ServicesConfig.base_url+"/offers?paginate=true&limit=100";
